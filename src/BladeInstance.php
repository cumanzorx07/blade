...
use cumanzorx07\Laravel\Directives\Directives;
use cumanzorx07\Laravel\Directives\DirectivesInterface;
use cumanzorx07\Laravel\Handlers\ConditionHandler;
...
class BladeInstance implements BladeInterface
{
    ...
    {
        return (!$this->finder) ? new FileViewFinder(new Filesystem(), [$this->path]) : $this->finder;
    }
