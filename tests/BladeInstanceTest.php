...
namespace cumanzorx07\LaravelTests;

use cumanzorx07\Laravel\BladeInstance;
...
class BladeInstanceTest extends TestCase
{
    ...
    {
        echo file_get_contents(__DIR__ . "/views/alt/view3.blade.php");
    ...
    public function testNamespace(): void
    {
        ...
        $this->assertSame("cumanzorx07\\Laravel", trim($result));
    }
